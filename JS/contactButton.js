...
firstPlatform.addEventListener('click', () => {
    window.open("https://www.instagram.com/_yogya_rai_/");
});
secondPlatform.addEventListener('click', () => {
    window.open("mailto:yogyarai6270@gmail.com");
});
thirdPlatform.addEventListener('click', () => {
    window.open("https://github.com/yogyarai");
});
fourthPlatform.addEventListener('click', () => {
    window.open("https://www.linkedin.com/in/yogya-rai-b67aa3213/");
});